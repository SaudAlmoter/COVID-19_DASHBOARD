...
public class Dashboard extends JFrame {
	...
	private void addAverageVaccinationsPerDay() {
		...
		// Population in 2005
		dataset.addValue(vac.getAvgVaccinatedPerDay(countryName), "People Vaccinated", "");
		dataset.addValue(vac.getAvgFullyVaccinatedPerDay(countryName), "People Fully Vaccinated", "");
